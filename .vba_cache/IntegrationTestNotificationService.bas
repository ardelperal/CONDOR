Attribute VB_Name = "IntegrationTestNotificationService"
...
Public Function IntegrationTestNotificationServiceRunAll() As CTestSuiteResult
    Dim suiteResult As New CTestSuiteResult
    Call suiteResult.Initialize("IntegrationTestNotificationService")
    ...
    Set IntegrationTestNotificationServiceRunAll = suiteResult
End Function
