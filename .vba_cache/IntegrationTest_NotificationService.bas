...
Public Function IntegrationTest_NotificationService_RunAll() As CTestSuiteResult
    Dim suiteResult As New CTestSuiteResult
    Call suiteResult.Initialize("IntegrationTest_NotificationService - Pruebas de Integración CNotificationService")
    ...
    Set IntegrationTest_NotificationService_RunAll = suiteResult
End Function
