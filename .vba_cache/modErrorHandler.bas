...
' Registra un error crítico en la base de datos
' @param numeroError: Número del error crítico
' @param mensaje: Mensaje del error crítico
' @param modulo: Módulo origen del error crítico
Public Sub LogCriticalError(ByVal numeroError As Long, ByVal mensaje As String, ByVal modulo As String)
    ...
    ' Insertar registro de error crítico en tbLogErrores
    strSQL = "INSERT INTO tbLogErrores (" & _
             "Fecha_Hora, " & _
             "Numero_Error, " & _
             "Descripcion_Error, " & _
             "Origen_Error, " & _
...
ErrorHandler:
    ' Si falla el logging a base de datos, escribir a log local
    Call WriteToLocalLog("ERROR EN modErrorHandler.LogCriticalError: " & Err.Description & " - Mensaje original: " & mensaje)
...
' Registra una advertencia en la base de datos
' @param mensaje: Mensaje de advertencia
' @param modulo: Módulo origen de la advertencia
Public Sub LogWarning(ByVal mensaje As String, ByVal modulo As String)
    On Error GoTo ErrorHandler
    ...
    ' Insertar registro de advertencia en tbLogErrores
    strSQL = "INSERT INTO tbLogErrores (" & _
             "Fecha_Hora, " & _
             "Numero_Error, " & _
             "Descripcion_Error, " & _
...
ErrorHandler:
    ' Si falla el logging a base de datos, escribir a log local
    Call WriteToLocalLog("ERROR EN modErrorHandler.LogWarning: " & Err.Description & " - Mensaje original: " & mensaje)
