...
' Proporciona acceso a la instancia única del servicio de configuración
...
' Función factory/singleton para obtener la instancia de configuración
...
' Función de inicialización del entorno (delegada a CConfig)
...
' Función para obtener la ruta de la base de datos principal
...
' Función para obtener la ruta de la base de datos de datos
...
' Función para obtener la ruta de la base de datos de Expedientes
...
' Función para obtener la ruta de la base de datos de Expedientes (alias para compatibilidad)
...
' Función para obtener la ruta de las plantillas
...
' Función para obtener la ruta de código fuente
...
' Función para obtener la ruta de backups
...
' Función para obtener la ruta de logs
...
' Función para obtener la ruta temporal
...
' Función de prueba (delegada a CConfig)
