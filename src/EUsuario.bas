...
'******************************************************************************
' CLASE: EUsuario
' DESCRIPCIÓN: Tipo de datos para almacenar información de usuarios del sistema
' AUTOR: Sistema CONDOR
' FECHA: 2024
' NOTA: Propiedades definidas basándose en especificación funcional y servicios de autenticación
'******************************************************************************
