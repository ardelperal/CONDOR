...
Public Function Test_LogError_StandardError_LogsSuccessfully() As Boolean
    ...
    Dim errDesc As String: errDesc = "Error de prueba est├índar"
...
Public Function Test_LogError_CriticalError_CreatesNotification() As Boolean
    ...
    g_MockNotif.LastNotificationSubject = "ERROR CR├ìTICO en CONDOR - " & errSource
...
Public Function Test_IsCriticalError_StandardErrors_ReturnsFalse() As Boolean
    ...
    ' Arrange & Act & Assert
    ' Simular verificaci├│n de errores est├índar (no cr├¡ticos)
...
Public Function Test_EdgeCase_ConcurrentAccess_HandlesCorrectly() As Boolean
    ...
    ' Act
    ' Simular acceso concurrente (m├║ltiples errores simult├íneos)
    Dim i As Integer
    For i = 1 To 5
        g_MockLogDB.RecordsInserted = g_MockLogDB.RecordsInserted + 1
    Next i
...
Public Function RunErrorHandlerExtendedTests() As Boolean
    ...
    If Test_LogError_StandardError_LogsSuccessfully() Then
        Debug.Print "Ô£ô Test_LogError_StandardError_LogsSuccessfully: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_LogError_StandardError_LogsSuccessfully: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_LogError_CriticalError_CreatesNotification() Then
        Debug.Print "Ô£ô Test_LogError_CriticalError_CreatesNotification: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_LogError_CriticalError_CreatesNotification: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_LogError_DatabaseFailure_WritesToLocalLog() Then
        Debug.Print "Ô£ô Test_LogError_DatabaseFailure_WritesToLocalLog: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_LogError_DatabaseFailure_WritesToLocalLog: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_LogError_SpecialCharacters_HandlesCorrectly() Then
        Debug.Print "Ô£ô Test_LogError_SpecialCharacters_HandlesCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_LogError_SpecialCharacters_HandlesCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_IsCriticalError_DatabaseErrors_ReturnsTrue() Then
        Debug.Print "Ô£ô Test_IsCriticalError_DatabaseErrors_ReturnsTrue: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_IsCriticalError_DatabaseErrors_ReturnsTrue: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_IsCriticalError_MemoryErrors_ReturnsTrue() Then
        Debug.Print "Ô£ô Test_IsCriticalError_MemoryErrors_ReturnsTrue: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_IsCriticalError_MemoryErrors_ReturnsTrue: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_IsCriticalError_StandardErrors_ReturnsFalse() Then
        Debug.Print "Ô£ô Test_IsCriticalError_StandardErrors_ReturnsFalse: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_IsCriticalError_StandardErrors_ReturnsFalse: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_CreateAdminNotification_ValidData_CreatesNotification() Then
        Debug.Print "Ô£ô Test_CreateAdminNotification_ValidData_CreatesNotification: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CreateAdminNotification_ValidData_CreatesNotification: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CreateAdminNotification_DatabaseFail_WritesToLocalLog() Then
        Debug.Print "Ô£ô Test_CreateAdminNotification_DatabaseFail_WritesToLocalLog: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CreateAdminNotification_DatabaseFail_WritesToLocalLog: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_WriteToLocalLog_ValidMessage_WritesSuccessfully() Then
        Debug.Print "Ô£ô Test_WriteToLocalLog_ValidMessage_WritesSuccessfully: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_WriteToLocalLog_ValidMessage_WritesSuccessfully: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_WriteToLocalLog_FileSystemError_HandlesGracefully() Then
        Debug.Print "Ô£ô Test_WriteToLocalLog_FileSystemError_HandlesGracefully: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_WriteToLocalLog_FileSystemError_HandlesGracefully: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_LogCurrentError_WithValidError_LogsCorrectly() Then
        Debug.Print "Ô£ô Test_LogCurrentError_WithValidError_LogsCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_LogCurrentError_WithValidError_LogsCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_CleanOldLogs_ValidExecution_RemovesOldRecords() Then
        Debug.Print "Ô£ô Test_CleanOldLogs_ValidExecution_RemovesOldRecords: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CleanOldLogs_ValidExecution_RemovesOldRecords: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CleanOldLogs_DatabaseError_WritesToLocalLog() Then
        Debug.Print "Ô£ô Test_CleanOldLogs_DatabaseError_WritesToLocalLog: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CleanOldLogs_DatabaseError_WritesToLocalLog: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_Integration_ErrorFlow_CompleteProcess() Then
        Debug.Print "Ô£ô Test_Integration_ErrorFlow_CompleteProcess: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_Integration_ErrorFlow_CompleteProcess: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_Integration_FallbackMechanism_WorksCorrectly() Then
        Debug.Print "Ô£ô Test_Integration_FallbackMechanism_WorksCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_Integration_FallbackMechanism_WorksCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_EdgeCase_VeryLongErrorMessage_HandlesCorrectly() Then
        Debug.Print "Ô£ô Test_EdgeCase_VeryLongErrorMessage_HandlesCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_EdgeCase_VeryLongErrorMessage_HandlesCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_EdgeCase_NullAndEmptyValues_HandlesCorrectly() Then
        Debug.Print "Ô£ô Test_EdgeCase_NullAndEmptyValues_HandlesCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_EdgeCase_NullAndEmptyValues_HandlesCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_EdgeCase_ConcurrentAccess_HandlesCorrectly() Then
        Debug.Print "Ô£ô Test_EdgeCase_ConcurrentAccess_HandlesCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_EdgeCase_ConcurrentAccess_HandlesCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    If failedTests = 0 Then
        Debug.Print "\n­ƒÄë ┬íTODAS LAS PRUEBAS EXTENDIDAS PASARON!"
    Else
