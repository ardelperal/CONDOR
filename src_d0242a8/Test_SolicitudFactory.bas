...
Public Function RunSolicitudFactoryTests() As Boolean
    ...
    If Test_CreateSolicitud_ValidID_ReturnsCSolicitudPC() Then
        Debug.Print "Ô£ô Test_CreateSolicitud_ValidID_ReturnsCSolicitudPC: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CreateSolicitud_ValidID_ReturnsCSolicitudPC: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CreateSolicitud_InvalidID_ReturnsNothing() Then
        Debug.Print "Ô£ô Test_CreateSolicitud_InvalidID_ReturnsNothing: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CreateSolicitud_InvalidID_ReturnsNothing: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CreateSolicitud_ZeroID_ReturnsNothing() Then
        Debug.Print "Ô£ô Test_CreateSolicitud_ZeroID_ReturnsNothing: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CreateSolicitud_ZeroID_ReturnsNothing: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_GetTipoSolicitud_DefaultsToPC() Then
        Debug.Print "Ô£ô Test_GetTipoSolicitud_DefaultsToPC: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_GetTipoSolicitud_DefaultsToPC: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_Factory_CreatesValidISolicitudInterface() Then
        Debug.Print "Ô£ô Test_Factory_CreatesValidISolicitudInterface: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_Factory_CreatesValidISolicitudInterface: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_Factory_HandlesDatabaseErrors() Then
        Debug.Print "Ô£ô Test_Factory_HandlesDatabaseErrors: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_Factory_HandlesDatabaseErrors: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_CSolicitudPC_Properties_SetAndGet() Then
        Debug.Print "Ô£ô Test_CSolicitudPC_Properties_SetAndGet: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CSolicitudPC_Properties_SetAndGet: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CSolicitudPC_Load_ReturnsTrue() Then
        Debug.Print "Ô£ô Test_CSolicitudPC_Load_ReturnsTrue: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CSolicitudPC_Load_ReturnsTrue: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CSolicitudPC_Save_ReturnsTrue() Then
        Debug.Print "Ô£ô Test_CSolicitudPC_Save_ReturnsTrue: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CSolicitudPC_Save_ReturnsTrue: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CSolicitudPC_ChangeState_ReturnsTrue() Then
        Debug.Print "Ô£ô Test_CSolicitudPC_ChangeState_ReturnsTrue: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CSolicitudPC_ChangeState_ReturnsTrue: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CSolicitudPC_DatosPC_SetAndGet() Then
        Debug.Print "Ô£ô Test_CSolicitudPC_DatosPC_SetAndGet: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CSolicitudPC_DatosPC_SetAndGet: FALL├ô"
        failedTests = failedTests + 1
    End If
    ...
    totalTests = totalTests + 1
    If Test_CreateSolicitud_LargeID_HandlesCorrectly() Then
        Debug.Print "Ô£ô Test_CreateSolicitud_LargeID_HandlesCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CreateSolicitud_LargeID_HandlesCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
    
    totalTests = totalTests + 1
    If Test_CSolicitudPC_SpecialCharacters_HandlesCorrectly() Then
        Debug.Print "Ô£ô Test_CSolicitudPC_SpecialCharacters_HandlesCorrectly: PAS├ô"
        passedTests = passedTests + 1
    Else
        Debug.Print "Ô£ù Test_CSolicitudPC_SpecialCharacters_HandlesCorrectly: FALL├ô"
        failedTests = failedTests + 1
    End If
