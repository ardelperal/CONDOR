-- ============================================================================
-- Script: 008_refactor_tbTransiciones.sql
-- Descripción: Refactorización completa de tbTransiciones para el nuevo flujo de trabajo
-- Fecha: 2024
-- Autor: CONDOR-Developer
-- ============================================================================

-- Eliminar tabla existente para garantizar idempotencia
DROP TABLE IF EXISTS tbTransiciones;
